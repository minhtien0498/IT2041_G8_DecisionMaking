...
```json
{
  ...
  "candidate_generation": {
    ...
    "solution_ids": ["Solution 2", "Solution 1"],
    "candidate_count": 12
  },
  "candidates": [
    {
...
```text
candidate_set = union(Top 10 solution 2, Top 10 solution 1)
```
...
## 7. Metrics dùng để so sánh solution 2 và Solution 1
...
```text
Nếu AvgRel@5 của solution 1 > solution 2 trong một scenario, Solution 1 thắng scenario đó.
```
...
Solution 1 wins: y/30 scenarios
ties: z/30 scenarios
```

### 7.7. Stability / Sensitivity

Quan trọng riêng cho solution 1:
...
2. Tạo candidate set từ Top 10 của Solution 2 và Solution 1.
...
## 11. Liên hệ với solution 2 và Solution 1
