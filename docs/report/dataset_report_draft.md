...
Những cột được xem là cột nền để hai solution cùng dùng gồm:
...
Việc khóa bộ cột này giúp Solution 1 và Solution 2 chạy trên cùng một nguồn thông tin. Tuy nhiên, ở bộ 100 căn hiện tại, các cột khoảng cách POI vẫn đang là `None`, nên nếu muốn dùng cho ranking có POI thì cần enrich tiếp.
...
1. Hai solution có thể chạy trên cùng một bộ dữ liệu.
...
- phần mô tả Solution 1 và Solution 2
