...
Quy ước hiện tại:
- `Solution 1`: hướng cũ đã bị loại, chỉ giữ làm baseline/historical reference
...
- `Solution 1` tối ưu về mô hình ra quyết định đa tiêu chí, độ ổn định và khả năng phân tích trade-off.

## 8. So Sánh Solution 2 và Solution 1

| Tiêu chí | Solution 2 | Solution 1 |
|---|---|---|
| Constraint satisfaction | Cao nếu parser + rerank đúng | Cao nếu ma trận quyết định và trọng số đúng |
| Top-K relevance | Tốt hơn khi user có nhu cầu tự nhiên / free-text | Tốt hơn khi trade-off tiêu chí đã lượng hóa rõ |
| Explainability | Cao nếu explanation bám đúng score và enriched data | Cao do quy trình MCDA/TOPSIS minh bạch |
| Flexibility | Cao | Trung bình-cao |
| Latency | Cao hơn | Thấp hơn / ổn định hơn |
| API cost | Cao hơn | Thấp hơn |
